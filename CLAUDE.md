...
node test-permisos.js      # 247 tests · roles, planes, el gate, el selector, el hub, el ciclo y la sesión
...
**2824 tests en total. Todos tienen que dar verde antes de commitear.**
...
**Versión actual de assets: `?v=155`.** Los `<script>` llevan query string para
