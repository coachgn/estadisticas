...
node test-permisos.js      # 246 tests · roles, planes, el gate, el selector, el hub, el ciclo y la sesión
...
**2822 tests en total. Todos tienen que dar verde antes de commitear.**
...
**Versión actual de assets: `?v=154`.** Los `<script>` llevan query string para
