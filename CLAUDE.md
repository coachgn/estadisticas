...
node test-permisos.js      # 194 tests · roles, planes, el gate, el selector de cliente y el hub

node test-backend.js       # 360 tests · el proxy, el benchmark, las alertas, el catálogo en KV
...
**2688 tests en total. Todos tienen que dar verde antes de commitear.**
...
**Versión actual de assets: `?v=149`.** Los `<script>` llevan query string para
