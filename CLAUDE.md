...
node test-permisos.js      # 245 tests · roles, planes, el gate, el selector, el hub, el ciclo y la sesión

node test-backend.js       # 438 tests · el proxy, el benchmark, las alertas, el catálogo en KV
...
**2821 tests en total. Todos tienen que dar verde antes de commitear.**
...
**Versión actual de assets: `?v=153`.** Los `<script>` llevan query string para
