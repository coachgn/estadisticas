 ...
 *
 * Copia mecánica de js/sgadd-core.js, que es la fuente de verdad.
...
(function (raiz) {
  ...
  */
  ...
  const SECCIONES = ['principal', 'clasificacion', 'fixture', 'equipos', 'jugadores', 'scouting', 'simulador', 'configuracion', 'diagnostico', 'glosario', 'comparativa'];
